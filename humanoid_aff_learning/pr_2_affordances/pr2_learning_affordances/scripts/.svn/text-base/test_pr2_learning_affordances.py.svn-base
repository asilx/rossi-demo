#test client for pr2_learning_affordances

import roslib
roslib.load_manifest('pr2_learning_affordances')
import rospy
from pr2_learning_affordances.srv import ExecuteCartesianIKTrajectory
