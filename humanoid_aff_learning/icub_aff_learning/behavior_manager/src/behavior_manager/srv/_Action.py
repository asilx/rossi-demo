...
class ActionRequest(roslib.message.Message):
  _md5sum = "ddc8d05569ef3b27a14579c2b5cc4e70"
...
"""
  ...
  __slots__ = ['task','arg','pushable_object_center','pushable_object_size','experimentEpoch']
  _slot_types = ['int8','int8','float32[]','float32[]','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       task,arg,pushable_object_center,pushable_object_size,experimentEpoch
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_B.pack(self.experimentEpoch))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.experimentEpoch,) = _struct_B.unpack(str[start:end])
      return self
...
class Action(roslib.message.ServiceDefinition):
  ...
  _md5sum = 'ac065fe0178768b8f4c4d0241aa49c96'
