/* Auto-generated by genmsg_cpp for file /home/kadir/interconnection/workspace/metu-ros-pkg/stacks/aff_learning/humanoid_aff_learning/icub_aff_learning/behavior_manager_test/srv/Action.srv */
#ifndef BEHAVIOR_MANAGER_TEST_SERVICE_ACTION_H
#define BEHAVIOR_MANAGER_TEST_SERVICE_ACTION_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
namespace behavior_manager_test
{
...
private:
  static const char* __s_getDataType_() { return "behavior_manager_test/ActionRequest"; }
public:
...
public:
  ...
  typedef boost::shared_ptr< ::behavior_manager_test::ActionRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::behavior_manager_test::ActionRequest_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct ActionRequest
typedef  ::behavior_manager_test::ActionRequest_<std::allocator<void> > ActionRequest;

typedef boost::shared_ptr< ::behavior_manager_test::ActionRequest> ActionRequestPtr;
typedef boost::shared_ptr< ::behavior_manager_test::ActionRequest const> ActionRequestConstPtr;
...
private:
  static const char* __s_getDataType_() { return "behavior_manager_test/ActionResponse"; }
public:
  ROS_DEPRECATED static const std::string __s_getDataType() { return __s_getDataType_(); }
...
public:
  ...
  typedef boost::shared_ptr< ::behavior_manager_test::ActionResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::behavior_manager_test::ActionResponse_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct ActionResponse
typedef  ::behavior_manager_test::ActionResponse_<std::allocator<void> > ActionResponse;

typedef boost::shared_ptr< ::behavior_manager_test::ActionResponse> ActionResponsePtr;
typedef boost::shared_ptr< ::behavior_manager_test::ActionResponse const> ActionResponseConstPtr;
...
{
template<class ContainerAllocator> struct IsMessage< ::behavior_manager_test::ActionRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::behavior_manager_test::ActionRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::behavior_manager_test::ActionRequest_<ContainerAllocator> > {
  static const char* value() 
  {
    return "6f28010420559760ce532a04644ecab7";
  }

  static const char* value(const  ::behavior_manager_test::ActionRequest_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x6f28010420559760ULL;
  static const uint64_t static_value2 = 0xce532a04644ecab7ULL;
};

template<class ContainerAllocator>
struct DataType< ::behavior_manager_test::ActionRequest_<ContainerAllocator> > {
  static const char* value() 
  {
    return "behavior_manager_test/ActionRequest";
  }
...
template<class ContainerAllocator>
struct Definition< ::behavior_manager_test::ActionRequest_<ContainerAllocator> > {
  static const char* value() 
  {
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::behavior_manager_test::ActionResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::behavior_manager_test::ActionResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::behavior_manager_test::ActionResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "0c33925582a4cf8db9f48c73fab8a9c4";
  }

  static const char* value(const  ::behavior_manager_test::ActionResponse_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x0c33925582a4cf8dULL;
  static const uint64_t static_value2 = 0xb9f48c73fab8a9c4ULL;
};

template<class ContainerAllocator>
struct DataType< ::behavior_manager_test::ActionResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "behavior_manager_test/ActionResponse";
  }
...
template<class ContainerAllocator>
struct Definition< ::behavior_manager_test::ActionResponse_<ContainerAllocator> > {
  static const char* value() 
  {
    return "\n\
uint8 DONE = 1\n\
...
template<class ContainerAllocator> struct IsFixedSize< ::behavior_manager_test::ActionResponse_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::behavior_manager_test::ActionRequest_<ContainerAllocator> >
{
...
template<class ContainerAllocator> struct Serializer< ::behavior_manager_test::ActionResponse_<ContainerAllocator> >
{
  template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
  {
...
{
template<>
struct MD5Sum<behavior_manager_test::Action> {
  static const char* value() 
  {
    return "9900281ecfdf116827776adaa867e6d8";
  }

  static const char* value(const behavior_manager_test::Action&) { return value(); } 
};

template<>
struct DataType<behavior_manager_test::Action> {
  static const char* value() 
  {
    return "behavior_manager_test/Action";
  }
...
#endif // BEHAVIOR_MANAGER_TEST_SERVICE_ACTION_H
