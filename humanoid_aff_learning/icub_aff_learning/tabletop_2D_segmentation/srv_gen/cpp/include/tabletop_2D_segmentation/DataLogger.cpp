...
void DataLogger::logSingleData(ImageFeatureTuple *currentImgInfo, int label)
{
	...
	rawS << savePath << "image_raw_" << label << "@" << timeReading << ".dat";
	filS << savePath << "image_filtered_" << label << "@" << timeReading << ".dat";
	otherS << savePath << "image_general_" << label << "@" << timeReading << ".dat";
	...
	filf << currentImgInfo->filimg_header_seq << " " << currentImgInfo->filimg_header_stamp << " " << currentImgInfo->filimg_header_frame_id << " " << currentImgInfo->filimg_height << " " << currentImgInfo->filimg_width << " " << currentImgInfo->filimg_step << " " << currentImgInfo->filimg_is_bigendian << " " << currentImgInfo->filimg_encoding;
	...
	// Color histograms: TODO: this is ugly. maybe use a generalized function
