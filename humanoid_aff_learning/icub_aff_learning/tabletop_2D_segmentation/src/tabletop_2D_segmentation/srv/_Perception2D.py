...
class Perception2DRequest(roslib.message.Message):
  _md5sum = "219d39248bdfd6b856612192d2849a69"
...
"""
  ...
  __slots__ = ['task','arg','arg2','experimentEpoch']
  _slot_types = ['uint8','int8','int8','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.arg2 is None:
        self.arg2 = 0
      if self.experimentEpoch is None:
        self.experimentEpoch = 0
    else:
      self.task = 0
      self.arg = 0
      self.arg2 = 0
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B2bB.pack(_x.task, _x.arg, _x.arg2, _x.experimentEpoch))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.task, _x.arg, _x.arg2, _x.experimentEpoch,) = _struct_B2bB.unpack(str[start:end])
      return self
...
class Perception2DResponse(roslib.message.Message):
  _md5sum = "7b8d1e09f28e82a30370c520355741db"
...
"""
  __slots__ = ['raw_image','filtered_image','rois','face_detected','ooi_area','ooi_color_r_hist','ooi_color_g_hist','ooi_color_b_hist']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       raw_image,filtered_image,rois,face_detected,ooi_area,ooi_color_r_hist,ooi_color_g_hist,ooi_color_b_hist
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_Bh.pack(_x.face_detected, _x.ooi_area))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.face_detected, _x.ooi_area,) = _struct_Bh.unpack(str[start:end])
...
class Perception2D(roslib.message.ServiceDefinition):
  ...
  _md5sum = 'b967eca97a24f16bdd63c4e02f1eca2d'
