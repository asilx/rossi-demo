...
(cl:defmethod cl:initialize-instance :after ((m <Perception-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Perception-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name al_srvs-srv:<Perception-request> is deprecated: use al_srvs-srv:Perception-request instead.")))

(cl:ensure-generic-function 'task-val :lambda-list '(m))
(cl:defmethod task-val ((m <Perception-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader al_srvs-srv:task-val is deprecated.  Use al_srvs-srv:task instead.")
  (task m))

(cl:ensure-generic-function 'arg-val :lambda-list '(m))
(cl:defmethod arg-val ((m <Perception-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader al_srvs-srv:arg-val is deprecated.  Use al_srvs-srv:arg instead.")
  (arg m))

(cl:ensure-generic-function 'arg_effect-val :lambda-list '(m))
(cl:defmethod arg_effect-val ((m <Perception-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader al_srvs-srv:arg_effect-val is deprecated.  Use al_srvs-srv:arg_effect instead.")
  (arg_effect m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Perception-request>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'arg_effect)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    )
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Perception-request>) istream)
  "Deserializes a message object of type '<Perception-request>"
    ...
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'arg_effect) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Perception-request>)))
  ...
  "e623ddd26925b15d65f272b948a6f870")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Perception-request)))
  "Returns md5sum for a message object of type 'Perception-request"
  "e623ddd26925b15d65f272b948a6f870")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Perception-request>)))
  ...
  (cl:format cl:nil "~%uint8 DO_PERCEPT = 0~%uint8 EXTRACT_EFFECT = 1~%uint8 task~%int8 arg~%int8 arg_effect~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Perception-request)))
  "Returns full string definition for message of type 'Perception-request"
  (cl:format cl:nil "~%uint8 DO_PERCEPT = 0~%uint8 EXTRACT_EFFECT = 1~%uint8 task~%int8 arg~%int8 arg_effect~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Perception-request>))
  ...
  (cl:list 'Perception-request
    ...
    (cl:cons ':arg (arg msg))
    (cl:cons ':arg_effect (arg_effect msg))
))
...
(cl:defmethod cl:initialize-instance :after ((m <Perception-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Perception-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name al_srvs-srv:<Perception-response> is deprecated: use al_srvs-srv:Perception-response instead.")))

(cl:ensure-generic-function 'feedback-val :lambda-list '(m))
(cl:defmethod feedback-val ((m <Perception-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader al_srvs-srv:feedback-val is deprecated.  Use al_srvs-srv:feedback instead.")
  (feedback m))
...
(cl:defmethod pushable_object_center-val ((m <Perception-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader al_srvs-srv:pushable_object_center-val is deprecated.  Use al_srvs-srv:pushable_object_center instead.")
...
(cl:defmethod pushable_object_size-val ((m <Perception-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader al_srvs-srv:pushable_object_size-val is deprecated.  Use al_srvs-srv:pushable_object_size instead.")
