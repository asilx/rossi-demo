"""autogenerated by genmsg_py from WorkspaceDetection.msg. Do not edit."""
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WorkspaceDetection, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.tabletop is None:
        self.tabletop = tabletop_object_detector.msg.TabletopDetectionResult()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.tabletop.table.pose.header.seq, _x.tabletop.table.pose.header.stamp.secs, _x.tabletop.table.pose.header.stamp.nsecs))
      _x = self.tabletop.table.pose.header.frame_id
      length = len(_x)
      ...
      length = len(self.tabletop.models)
      buff.write(_struct_I.pack(length))
      for val1 in self.tabletop.models:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.pack(pattern, *self.tabletop.cluster_model_indices))
      _x = self
      buff.write(_struct_i3I.pack(_x.tabletop.result, _x.table.pose.header.seq, _x.table.pose.header.stamp.secs, _x.table.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tabletop.table.pose.header.seq, _x.tabletop.table.pose.header.stamp.secs, _x.tabletop.table.pose.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        self.tabletop.clusters.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.tabletop.models = []
      for i in range(0, length):
      ...
      self.tabletop.cluster_model_indices = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 16
      (_x.tabletop.result, _x.table.pose.header.seq, _x.table.pose.header.stamp.secs, _x.table.pose.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.tabletop.cluster_model_indices.tostring())
      _x = self
      buff.write(_struct_i3I.pack(_x.tabletop.result, _x.table.pose.header.seq, _x.table.pose.header.stamp.secs, _x.table.pose.header.stamp.nsecs))
      _x = self.table.pose.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.tabletop.cluster_model_indices = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      _x = self
      start = end
      end += 16
      (_x.tabletop.result, _x.table.pose.header.seq, _x.table.pose.header.stamp.secs, _x.table.pose.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
